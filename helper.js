...
(function() {
  ...
  function render(gs) {
    ...
    var resIcons = { lumber: 'https://piravlos.github.io/catan/images/wood.png', brick: 'https://piravlos.github.io/catan/images/brick.png', wool: 'https://piravlos.github.io/catan/images/sheep.png', grain: 'https://piravlos.github.io/catan/images/grain.png', ore: 'https://piravlos.github.io/catan/images/stone.png' };
    var buildIcons = { road: 'https://piravlos.github.io/catan/images/road.png', settlement: 'https://piravlos.github.io/catan/images/settlement.png', city: 'https://piravlos.github.io/catan/images/city.png', wall: 'https://piravlos.github.io/catan/images/wall.png', knight: 'https://piravlos.github.io/catan/images/knight.png', activate: 'https://piravlos.github.io/catan/images/activate.png', promote: 'https://piravlos.github.io/catan/images/strongknight.png', mighty: 'https://piravlos.github.io/catan/images/mightyknight.png' };
    function costStr(c) { var s = []; for (var k in c) s.push(c[k] + "<img src='" + resIcons[k] + "' class='resImg'>"); return s.join(" "); }
    ...
    if (gameType === 'classic') {
      ...
      for (var k in B_CLASSIC) { var b = B_CLASSIC[k], ok = canBuild(b.c); var iconHtml = buildIcons[k] ? "<img src='" + buildIcons[k] + "' class='buildImg'>" : "<span class='icon'>" + b.i + "</span>"; h += "<div class='chBi " + (ok ? "y" : "n") + "'>" + iconHtml + "<div class='info'><div class='name'>" + t(b.nKey) + "</div><div class='cost'>" + costStr(b.c) + "</div></div></div>"; }
      h += "</div></div>";
      ...
      h += "<div class='chS'><div class='chT'>" + t("build") + "</div><div class='chB'>";
      for (var k in B_CK) { var b = B_CK[k], ok = canBuild(b.c); var iconHtml = buildIcons[k] ? "<img src='" + buildIcons[k] + "' class='buildImg'>" : "<span class='icon'>" + b.i + "</span>"; h += "<div class='chBi " + (ok ? "y" : "n") + "'>" + iconHtml + "<div class='info'><div class='name'>" + t(b.nKey) + "</div><div class='cost'>" + costStr(b.c) + "</div></div></div>"; }
      h += "</div></div>";

      // Progress cards section
      var cds = ck.progress_cards || [];
      h += "<div class='chS'><div class='chT'>" + t("cards") + " (" + cds.length + ")</div><div class='chCds'>";
      if (cds.length === 0) h += "<div style='opacity:.5;text-align:center;padding:12px;font-size:28px'>" + t("noProgressCards") + "</div>";
