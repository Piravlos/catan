...
(function() {
  ...
  function render(gs) {
    ...
    h += "<div class='chDt'><span class='chDl'>🟡 Trade</span><div class='chDb'><div class='chDf trade' style='width:" + (tLv * 20) + "%'></div><span class='chDn'>" + tLv + "/5</span></div></div>";
    h += "<div class='chDt'><span class='chDl'>🟢 Science</span><div class='chDb'><div class='chDf science' style='width:" + (sLv * 20) + "%'></div><span class='chDn'>" + sLv + "/5</span></div></div>";
    h += "<div class='chDt'><span class='chDl'>🔵 Politics</span><div class='chDb'><div class='chDf politics' style='width:" + (pLv * 20) + "%'></div><span class='chDn'>" + pLv + "/5</span></div></div></div></div>";
